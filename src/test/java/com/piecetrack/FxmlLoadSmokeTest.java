...
import com.piecetrack.service.PiecePhotoService;
...
import com.piecetrack.ui.sales.SalesReturnScreenController;
...
class FxmlLoadSmokeTest {
    ...
    static class TestPathsConfig {
        ...
        AppPaths testAppPaths() throws IOException {
            return TestAppPathsFactory.create(Files.createTempDirectory("piecetrack-fxml-test-"));
        }
    }
    ...
    private static synchronized void ensureFxToolkitStarted() throws InterruptedException {
        ...
        // Same base theme the real app applies in PieceTrackFxApp.applyBaseTheme(). Without
    ...
    void pieceDetailScreenLoadsWithoutError() throws Exception {
        ...
        long modelId = itemModelService.create(new com.piecetrack.domain.ItemModel(

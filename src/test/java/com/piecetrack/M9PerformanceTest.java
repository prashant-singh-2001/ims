...
class M9PerformanceTest {
    ...
    static class TestPathsConfig {
        ...
        AppPaths testAppPaths() throws IOException {
            return TestAppPathsFactory.create(Files.createTempDirectory("piecetrack-m9-perf-test-"));
        }
    }
    ...
    private void seedOnce() {
        ...
        shopProfileRepository.save(new ShopProfile("Perf Test Shop", null, null, null, null,
        ...
        new TransactionTemplate(transactionManager).executeWithoutResult(status -> {
            ...
            jdbc.update("INSERT INTO storage_location (name) VALUES ('Godown')");
    ...
    private void seedPiecesAndInvoices(List<Long> itemModelIds, List<Long> customerIds, long locationId) {
        ...
        for (int i = 0; i < INVOICE_COUNT; i++) {
            ...
            String fy = com.piecetrack.util.FinancialYear.of(invoiceDate);
    ...
    void reportsAndSearchesCompleteWithinNfr04BudgetsAt20000PieceAnd20000InvoiceScale() {
        ...
        long pieceSearchMs = time(() -> pieceService.search(
                new PieceSearchCriteria(null, com.piecetrack.domain.Piece.State.IN_STOCK, null, null, null, null, null)));

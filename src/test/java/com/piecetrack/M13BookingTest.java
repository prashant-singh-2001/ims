...
class M13BookingTest {
    ...
    static class TestPathsConfig {
        ...
        AppPaths testAppPaths() throws IOException {
            return TestAppPathsFactory.create(Files.createTempDirectory("piecetrack-m13-test-"));
        }
    }
    ...
    void bothMarkDeliveredAndMarkNotDeliveredWriteAnAuditRow() {
        ...
        List<com.piecetrack.domain.AuditLog> markedRows = auditLogRepository.search(
                new AuditLogSearchCriteria(null, null, "DELIVERY_MARKED", "SALES_LINE"), 0);
        List<com.piecetrack.domain.AuditLog> unmarkedRows = auditLogRepository.search(

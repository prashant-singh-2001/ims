...
class M7ReportsTest {
    ...
    static class TestPathsConfig {
        ...
        AppPaths testAppPaths() throws IOException {
            return TestAppPathsFactory.create(Files.createTempDirectory("furniture-ims-m7-test-"));
        }
    }
    ...
    private long chairModelId(String code) {
        ...
        return itemModelService.create(new ItemModel(0, code, "Oak Dining Chair " + code, categoryId, "9403",
    ...
    void salesProfitNetsOutReturnedLines() {
        ...
        ReportService.SalesProfitAggregate byModel = report.byItemModel().stream()
                .filter(a -> a.label().equals("Oak Dining Chair RPTB")).findFirst().orElseThrow();
